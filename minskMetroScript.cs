...
public class minskMetroScript : MonoBehaviour
{
    ...
    private static readonly int[] limits = { 109, 209, 310, 410, 125, 224, 323, 426 };
    private const string base36 = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ";

    private static readonly Dictionary<int, string> stationNames = new Dictionary<int, string>()
    {
        {125, "Smalenskaja"},
        {224, "Krasny Bor"},
        {124, "Uručča"},
...
"transfer"
    ...
    private void Awake()
    {
        ...
        otherStations = stationNames.Values.Except(new[] { stationNames[current] }).ToArray();
        readyForSouv = true;
    }
